...
class Sqltipo extends JFrame implements ActionListener, MouseListener, KeyListener {
	...
	public void leGradeSql() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Erro na leitura tabela tipo:" + erro);
		}
	}///// legrade
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == btExcluir) {/// excluir
			...
			if (linex == -1)/// menos um
			{
				JOptionPane.showMessageDialog(null, "Escolha uma linha....", "Excluindo", -1);
				return;
			}
			if (JOptionPane.showConfirmDialog(null, "Excluir linha:" + tabela.getValueAt(linex, 1), "Excluindo",
					0) == 0)// sim=0 nao=1
			{
				bantipo.connect();
